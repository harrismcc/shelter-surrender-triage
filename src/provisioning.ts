...
const CATEGORY_COLORS: Record<Priority | IssueCategory, string> = {
  ...
  "Behavior / time": "preset1",
  "Financial hardship": "preset3",
  "Caregiver unavailable": "preset9",
  "Family change": "preset24",
  "Too many animals": "preset8",
  "Animal medical": "preset0",
  "Human bite / injury": "preset15",
  "Animal injury / death": "preset16",
  "Child or vulnerable": "preset14",
  "Cannot contain/separate": "preset17",
  "Acute animal suffering": "preset11",
  "No safe placement": "preset6",
  "Household safety": "preset23",
  "Abandonment / care": "preset18",
  "Humane euthanasia": "preset20",
